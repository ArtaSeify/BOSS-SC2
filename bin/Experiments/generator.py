...
total_runs = 20
simulations = [2500, 5000, 7500, 10000]
...
for simulation in simulations:
    for startingState in startingStates:
        exp_name = "Integral_CRMV_1.25_" + str(simulation) + "_" + str(startingState)
        ...
        SearchParameters_list["ExplorationConstant"] = 1.25
        ...
        MCTS_experiment["Experiments"][exp_name]["OutputDir"] = "./Results/" + str(startingState) + "/Integral/CRMV/" + str(simulation)
