...
void DFBB_BuildOrderSearchParameters::setRepetitions(ActionType a, size_t repetitions)
{ 
...
void DFBB_BuildOrderSearchParameters::setRepetitionThreshold(ActionType a, size_t thresh)	
{ 
...
size_t DFBB_BuildOrderSearchParameters::getRepetitions(ActionType a)
{ 
    BOSS_ASSERT(a.getID() >= 0 && a.getID() < m_repetitionValues.size(), "Action type not valid");
...
size_t DFBB_BuildOrderSearchParameters::getRepetitionThreshold(ActionType a)				
{ 
    BOSS_ASSERT(a.getID() >= 0 && a.getID() < m_repetitionThresholds.size(), "Action type not valid");
