        ...
        && m_results.nodeVisits < m_params.getNumberOfNodes())
    {
        ...
        else
        {
            ...
            if (promisingEdge->getChild() == nullptr)
            {
                ...
                backPropogation(promisingEdge, buildOrderIntegral);
            }
...
std::shared_ptr<Edge> CombatSearch_ParallelIntegralMCTS::getPromisingEdge(const std::shared_ptr<Node> & node, BuildOrderIntegral & buildOrderIntegral)
{    
...
void CombatSearch_ParallelIntegralMCTS::rollout(GameState & state, BuildOrderIntegral & buildOrderIntegral, bool terminal)
{
...
bool CombatSearch_ParallelIntegralMCTS::doRandomAction(GameState& state, BuildOrderIntegral& buildOrderIntegral)
{
...
void CombatSearch_ParallelIntegralMCTS::updateIntegralTerminal(const GameState & state, BuildOrderIntegral & buildOrderIntegral)
{
...
void CombatSearch_ParallelIntegralMCTS::updateBOIntegral(const GameState & state, const ActionAbilityPair & action, BuildOrderIntegral & buildOrderIntegral, bool terminal)
{
...
void CombatSearch_ParallelIntegralMCTS::backPropogation(const std::shared_ptr<Edge> & edge, const BuildOrderIntegral & buildOrderIntegral)
{
    Edge* nextEdge = &*edge;
...
bool CombatSearch_ParallelIntegralMCTS::changeRoot(int threadID)
{
...
void CombatSearch_ParallelIntegralMCTS::writeRootData(const BuildOrderIntegral & rootIntegral)
{
