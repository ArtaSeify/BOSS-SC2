...
namespace BOSS
{
    ...
    public:
        ...
        void setRepetitionThreshold(ActionType a, int thresh);

        //!!! MIC: changed to int
        int getRepetitions(ActionType a);
        int getMaxActions(ActionType a);
        int getRepetitionThreshold(ActionType a);
